# Generated by Powerlevel10k configuration wizard on 2026-03-09 at 08:35 CET.
...
() {
  ...
  function prompt_kakoune() {
    # Check if the session variable exists
    if [[ -n "$KKS_SESSION" ]]; then
      local client="${KKS_CLIENT:-null}"
      p10k segment -f green -i '󰰋' -t "${client}@${KKS_SESSION}"
    fi
  }
